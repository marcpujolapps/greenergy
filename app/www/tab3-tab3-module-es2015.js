...
let Tab3Page = class Tab3Page {
        ...
        return new Promise((resolve, reject) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (this.consumption) {
                ...
                const data = yield this.http
                    .get("https://dashboard-api.lucera.es/v1/contracts/electricity/61837/consumption/months?from=2020-01&to=2020-12", {}, {})
                    .catch((err) => {
                    console.log(err);
                    reject(err);
                });
    ...
    createYearChart() {
        const datasets = this.consumption.periods
            ...
            backgroundColor: period.period.price_type_name === "Punta"
                ? "rgb(0, 179, 47)"
                : "rgb(35, 235, 88)",
        }))
            .concat([
            {
                stack: false,
                label: "Generación",
                data: this.generation.outputs.monthly.fixed.map((month) => (month.E_m || 0) * ((this.num_placas * this.w_placa) / 1000)),
        ...
        if (this.yearBars) {
            ...
            this.yearBars = new chart_js__WEBPACK_IMPORTED_MODULE_3__["Chart"](this.yearChart.nativeElement, {
                type: "bar",
                data: {
                    labels: this.consumption.periods[0].months.map((month) => month.month_label),
                    datasets,
                },
                options: {
                    scales: {
    ...
    createDayChart() {
        const datasets = this.consumption_day.periods
            ...
            .concat([
            {
                stack: false,
                label: "Generación",
                data: this.generation_day.outputs.daily_profile.map((hour) => ((hour["G(i)"] || 0) / 1000) *
        ...
        if (this.dayBars) {
            ...
            this.dayBars = new chart_js__WEBPACK_IMPORTED_MODULE_3__["Chart"](this.dayChart.nativeElement, {
                type: "bar",
                data: {
                    labels: this.consumption_day.periods[0].hour.map((hour) => hour.hour + ""),
                    datasets,
                },
                options: {
                    scales: {
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("yearChart")
], Tab3Page.prototype, "yearChart", void 0);
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("dayChart")
], Tab3Page.prototype, "dayChart", void 0);
